<header class="text-gray-600 body-font">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
            <a href="{{ route('ranking') }}" class="mr-5 hover:text-gray-900">好感度ランキング</a>
            <a href="{{ route('unpopular') }}" class="mr-5 hover:text-gray-900">不人気ランキング</a>
            <a href="{{ route('trending',['period' => 'all']) }}" class="mr-5 hover:text-gray-900">トレンドランキング</a>
        </nav>
